...
namespace B_R.Models
{
    public class Equipamento
    {
        ...
        private readonly IList<ComentariosEquipamento> _comentariosEquipamento;
        public virtual IEnumerable<ComentariosEquipamento> ComentariosEquipamento { get { return _comentariosEquipamento; } }
        ...
        public Equipamento()
        {
           ...
           _logEquipamento = new List<LogEquipamento>();
            _comentariosEquipamento = new List<ComentariosEquipamento>();
        }
    }
